...
| Moving average arrow animation duration (in milliseconds)           | Number   | `800`                                | A positive number smaller or equal `3000` (3 seconds)                                                                                   |
| Moving average arrow animation                                      | Textbox  | `cubic-bezier(0.22, 1, 0.36, 1)`     | **Advanced setting**, see [this page](https://developer.mozilla.org/en-US/docs/Web/CSS/transition-timing-function) for more information |
| Main tick height (in pixels)                                        | Number   | `24`                                 | A number bigger or equal `8`                                                                                                            |
...
| Hit error ticks height (in pixels)                                  | Number   | `36`                                 | A number bigger or equal `8`                                                                                                            |
...
| Hit error ticks appearance animation                                | Textbox  | `cubic-bezier(0, 1, 0.33, 1)`        | **Advanced setting**, see [this page](https://developer.mozilla.org/en-US/docs/Web/CSS/transition-timing-function) for more information |
...
| Hit error ticks disappearance animation                             | Textbox  | `linear`                             | **Advanced setting**, see [this page](https://developer.mozilla.org/en-US/docs/Web/CSS/transition-timing-function) for more information |
